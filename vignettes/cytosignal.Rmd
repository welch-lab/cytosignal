...
### Combinational plots of 3D edge plot, gene expression, LRscore and cluster annotation
...
plotSignif2(cs, intr = "CPI-SS0D5E30C6C", slot.use = "GauEps-Raw", return.plot = TRUE, edge = T)
```
