...
plotEdge(cs, intr.use, slot.use = "diffusion-Raw", pt.size = 0.15)
```
...
plotSignif2(cs, intr = intr.use, slot.use = "diffusion-Raw", return.plot = TRUE, edge = TRUE, pt.size = 0.2)
```
...
set.seed(233)
intrDEG <- inferIntrDEG(cs, intr = intr.use, slot.use = "diffusion-Raw", signif.use = "result.spx")
